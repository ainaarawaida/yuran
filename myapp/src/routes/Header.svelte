<script>
  ...
  const logout = async (ele) => {
    ...
    let apioutput = requestdataapi({
      action: "GetLogoutLink",
    });

    LogoutLink = (await apioutput).logout_url;
    ...
    <div class="main-header-left">
      <div class="logo-wrapper">
        <a href="{_data.mypluginurl}/"
          ><img
            class="img-fluid"
            src="{_data.mypluginurl}/luq/assets/images/logo/logo.png"
            alt=""
          /></a
        >
      </div>
      <div class="dark-logo-wrapper">
        <a href="{_data.mypluginurl}/"
          ><img
            class="img-fluid"
            src="{_data.mypluginurl}/luq/assets/images/logo/dark-logo.png"
            alt=""
          /></a
        >
      </div>
            ...
            <ul class="chat-dropdown onhover-show-div">
              <li>
                <div class="media">
                  <img
                    ...
                    src="{mypluginurl}/luq/assets/images/user/4.jpg"
                    alt=""
                  />
                  <div class="media-body">
              ...
              <li>
                <div class="media">
                  <img
                    class="img-fluid rounded-circle me-3"
                    src="{mypluginurl}/luq/assets/images/user/1.jpg"
                    alt=""
                  />
                  <div class="media-body">
              ...
              <li>
                <div class="media">
                  <img
                    class="img-fluid rounded-circle me-3"
                    src="{mypluginurl}/luq/assets/images/user/2.jpg"
                    alt=""
                  />
                  <div class="media-body">
              ...
              <li class="text-center">
                <a class="f-w-700" href={mypluginurl}>See All </a>
              </li>
            </ul>
          </li> -->
